...
/* CDC polling task — runs on Core 0, polls for incoming commands */
...
extern "C" void app_main(void)
{
    ...
    /* USB CDC — init after UI so READY message appears after display is up */
    supermouse_cdc_init();

    /* CDC polling task on Core 0 (LVGL runs on Core 1) */
    xTaskCreatePinnedToCore(cdc_task, "cdc", 4096, NULL, 5, NULL, 0);
}
